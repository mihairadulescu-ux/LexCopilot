...
def redenumeste_fisiere_pe_drive():
    ...
    if INDEX_DRIVE_TARGET is not None:
        ...
        if 0 <= idx_zero < total_discuri:
            ...
            print("============================================================", flush=True)
            print(f"🎯 [VERSIUNEA 2.0] FIXAT STRICT PE DRIVE #{INDEX_DRIVE_TARGET} din {total_discuri}", flush=True)
        ...
        print("============================================================", flush=True)
        print(f"🌐 [VERSIUNEA 2.0] PROCESARE TOATE CELE {total_discuri} DISCURI", flush=True)
        print("============================================================", flush=True)
                ...
                for f in files:
                    ...
                    if nume_vechi == nume_nou_standard:
                        ...
                        if total_evaluate % 1000 == 0:
                            print(f"   ⏳ Evaluat {total_evaluate:,} fișiere strict în Drive #{idx} | Corectate: {total_redenumite:,}", flush=True)
                        continue
