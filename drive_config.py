...
# 2. Folder temporar pentru micro-indecși (folosește TEMPORARY_XML_INDEXES sau primul drive din DRIVE_FOLDER_XML)
FOLDER_TEMP_INDEXES_ID = os.getenv("TEMPORARY_XML_INDEXES") or FOLDERE_XML_IDS[0]

# 3. Funcție ajutătoare de stocare pentru download_XML.py
