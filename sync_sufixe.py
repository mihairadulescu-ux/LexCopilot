...
def descarca_si_salveaza_sufixe():
    ...
    # Contor pentru descărcări active
    download_counter = 0
            ...
            try:
                ...
                if descarcat_ok and os.path.exists(cale_pdf_temp) and os.path.getsize(cale_pdf_temp) > 2000:
                    ...
                    if download_counter % 40 == 0:
                        print(f"\n{YELLOW}☕ [Pauză inteligentă] Am descărcat {download_counter} sufixe. Așteptăm 5 minute (300s) ca serverul să își reseteze IP-ul...{RESET}\n")
                        time.sleep(300)
                else:
    ...
    print(f"🚀 Registru {nume_registru} actualizat cu sufixele în Drive!")
